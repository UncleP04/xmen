...
const Header: React.FC = () => {
  return (
    <div>
      <section className="relative w-[100%] flex justify-center align-middle lg:h-[100vh] h-[100vh] overflow-x-hidden">
        <Image
          src={BackgroundImg}
          alt="backImage.png"
          width={700}
        ...
        <div className="mt-[15%] lg:mt-[5%] z-10">
          <span className="flex justify-center align-center" data-aos="zoom-in" data-aos-duration="1000">
            ...
            <h1 className="uppercase text-[5em] lg:text-[10rem] font-bold">Men</h1>
          </span>
          <span><p className="text-[2em] font-semibold uppercase text-center" data-aos="zoom-in" data-aos-duration="1000">Join the party now</p></span>
        </div>
      </section>
    </div>
  );
